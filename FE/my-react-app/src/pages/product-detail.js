...
export default function ProductDetail() {
    // 1. Khởi tạo là null để dễ kiểm tra
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // Reset loading khi id thay đổi
                setLoading(true);
                const res = await fetch(`http://172.21.9.75:8080/VuaCaQPQ/products/${product_id}`);
    ...
    // 3. Màn hình lỗi hoặc không tìm thấy sản phẩm
    // Kiểm tra kỹ cấu trúc data (product.result hay product)
        ...
        <div className="bg-background-light dark:bg-background-dark font-body text-text-color dark:text-gray-300 min-h-screen flex flex-col">
            ...
            <main className="flex-grow">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 md:py-12">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
                        ...
                        <div className="flex flex-col h-full">
                            <div className="mb-6">
                                ...
                                <p className="text-sm font-medium text-text-color/60 dark:text-gray-400">Mã SP: {productData.product_id}</p>
                            </div>
                    ...
                    {/* TABS INFO - Dữ liệu tĩnh hoặc lấy từ API nếu có */}
                    <div className="mt-16 lg:mt-24">
                        ...
                        <ul class="list-disc list-inside space-y-2 pl-4">
                            <li><strong>Đặc điểm thịt:</strong>{productData.information}</li>
                            <li><strong>Bảo quản:</strong>{productData.cachbaoquan}</li>
                        </ul>
                    </div>
